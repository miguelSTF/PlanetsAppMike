package com.mikestf.planetsappmike.ui.register_user.components
        ...
        DatePickerDialog(
            ...
            confirmButton = {
                Button(
                    ...
                    onClick = {
                        state.selectedDateMillis?.plus(86400000)?.let {
                            onConfirmClicked(it)
                        }
                        dismissRequest()
                    }
            ...
            content = {
                DatePicker(
                    ...
                    headline = {
                        state.selectedDateMillis?.plus(86400000)?.toFormattedDateString()?.let {
                            Text(
